...
curl -L https://github.com/mbecker20/monitor/releases/download/v0.2.9/monitor > $BIN_PATH/monitor
chmod +x $BIN_PATH/monitor

echo "\ndownloading monitor periphery...\n"
systemctl --user stop periphery # in case its currently in use
curl -L https://github.com/mbecker20/monitor/releases/download/v0.2.9/periphery > $BIN_PATH/periphery
